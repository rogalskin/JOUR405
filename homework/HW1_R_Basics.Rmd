...
#Didn't have too much trouble, just didn't have tinyverse in and loaded and that took some time to figure out. Is there an optimal way to be setting up my file pathing? My computer is generally a little bit of a mess but I should probably keep all this neat (ngl would be nice if AI could organize my files for me)
